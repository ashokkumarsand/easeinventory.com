          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                <Button as={Link} href="/register" color="success" size="lg" className="font-black px-10 h-16 shadow-xl shadow-success/30 uppercase tracking-widest" radius="full">
                  Start Free Trial
                  <ArrowRight size={20} />
                </Button>
              ...
              <CardBody className="p-12 lg:p-20 text-center relative">
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    <Button as={Link} href="/register" color="success" size="lg" className="font-black px-12 h-16 shadow-xl shadow-success/30 uppercase tracking-widest" radius="full">
                      Start Free Trial
                      <ArrowRight size={20} />
                    </Button>
