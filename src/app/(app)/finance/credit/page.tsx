      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
           <div className="flex items-center gap-3 mb-2">
             ...
             <h1 className="text-3xl lg:text-4xl font-black tracking-tight font-heading">Udhaar Ledger</h1>
           </div>
           <p className="text-foreground/50 font-bold ml-1">Credit management and automated collection tracking.</p>
        </div>
