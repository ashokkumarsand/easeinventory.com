...
const menuItems = [
  ...
  { group: 'Operations', items: [
    ...
    { label: 'Placement Optimizer', icon: MapPin, href: '/placement-optimizer' },
    { label: 'Multi-Echelon', icon: Layers, href: '/multi-echelon' },
    { label: 'Lot Genealogy', icon: Fingerprint, href: '/lot-genealogy' },
    { label: 'SLA Management', icon: ClipboardCheck, href: '/sla-management' },
    ...
    { label: 'Remanufacturing', icon: RotateCcw, href: '/remanufacturing' },
